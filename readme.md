### Latihan Membuat sistem  CRUD (create, read, update, delete) sederhana dengan PHP Mysql

pertama download tools yang dibutuhkan dibawah ini:
...
buka phpmyadmin tambahkan database bernama `latihan1`
Selanjutnya  lalu import `data_barang.sql` di database `latihan1`


Buat folder di dalam htdocs lalu buat kan beberapa file berikut :
- koneksi.php
- tambah.php
- index.php
- ubah.php
...
diatas kita menggunakan input gambar maka diform kita wajib menambahkan `enctype="multipart/form-data"`
...
Selesai, sistem crud sederhana menggunakan php telah berhasil kita buat.
